    ...
    return (
        <div className='bg-gray-200 font-sans flex flex-col items-center'>
            <div className="bg-gray-300 p-4 text-center mb-4">
                <h1 className="">Challenge 7 - Final Project: Landing Page</h1>
            </div>
                ...
                <div className='max-w-4xl w-full'>
                    ...
                    <div className='my-4'>
                        ...
                        <div className='relative mt-4 flex'>
                            <div>
                                <a href='' className='bg-pink-500 text-indigo-100 font-bold mt-2 px-2 py-2 rounded-full text-xs uppercase'>Enroll Now</a>
                            </div>
                            <div className='absolute right-0 bg-white rounded-full flex justify-center items-center p-5 border-4 border-pink-500'>
                                <img className='w-16 h-16' src={tailwindLogo}></img>
                            </div>
                        </div>
                    </div>
                </div>            
            ...
            <div className="max-w-4xl mx-4">
                <h2 className="pb-1 font-bold text-xl text-indigo-700 border-b border-indigo-600">How It Works</h2>
                ...
                <h2 className=" mt-8 pb-1 font-bold text-xl text-indigo-700 border-b border-indigo-600">Advantages</h2>
                ...
                <div className="flex flex-col sm:flex-row sm:-mx-2">
                    ...
                    <div className="mt-4 sm:w-1/3">
                        <div className="bg-white h-full p-8 border-b-4 border-pink-500 rounded-lg flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            ...
                            <div className="text-center mt-2 text-gray-600 text-sm">Tailwind is designed with your happiness in mind. The ease of performing changes is refreshing.</div>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 sm:w-1/3">
                        <div className="bg-white h-full p-8 border-b-4 border-pink-500 rounded-lg flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            ...
                            <div className="text-center mt-2 text-gray-600 text-sm">Modern applications demand mobile-friendly & Tailwind's responsive modifiers make it easy.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-800 py-12 mt-12 w-full flex flex-col items-center border-t-2 norder-black">
                ...
                <form className="max-w-xl w-full text-gray-200 mt-4 px-8 md:px-0 md:-mx-2" action="#" method="post">
